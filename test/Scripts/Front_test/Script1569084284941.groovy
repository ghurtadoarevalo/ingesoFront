...
WebUI.click(findTestObject('Object Repository/Page_front/div_RUT'))
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_front/select career'), 'Ingenieria Comercial', true)
